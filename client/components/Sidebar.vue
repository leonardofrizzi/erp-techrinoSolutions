<template>
  ...
  >
    <div class="h-20 flex items-center justify-center p-4 border-b border-gray-700 flex-shrink-0">
      <NuxtImg 
        src="/logo-techrino.png" 
        class="transition-all duration-300"
        :class="isExpanded ? 'opacity-100 h-16' : 'opacity-0 h-0'"
      />
    </div>
    ...
    <div class="p-4 border-t border-gray-700 flex-shrink-0">
      <button 
        class="w-full h-12 flex items-center text-gray-300 hover:bg-red-700/50 hover:text-white transition-colors rounded-lg cursor-pointer"
        :class="isExpanded ? 'px-6 gap-4' : 'justify-center'"
      >
